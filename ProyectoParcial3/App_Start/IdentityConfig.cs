...
namespace ProyectoParcial3
{
    ...
    {
        public static readonly string DefaultMail = "pruebavisual4@gmail.com";
        ...
        public Task SendAsync(IdentityMessage message)
        {
            try
            {
                SmtpClient smtp = new SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential(DefaultMail, DefaultMailPass)
                };

                using (MailMessage messageToSend = new MailMessage(DefaultMail, message.Destination)
                {
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            // Configure la lógica de validación de ``` de usuario
