...
namespace ProyectoParcial3.Controllers
{
    ...
    public class ExamenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,FechaEntrega")] Examen examen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,FechaEntrega")] Examen examen)
        {
            if (ModelState.IsValid)
            {
